...
$char sAux[1000];
   ...
   strcat(sql, "  AND l3.tipo_lectura IN (1,2,3,4,7,8)) ");
   strcat(sql, "AND l2.fecha_lectura >= ? ");
   strcat(sql, "AND l2.tipo_lectura IN (1,2,3,4,7,8) ");   
...
$long *lFilas;
{
   ...
   $OPEN curElectro USING :nroCliente;
...
$long *lFilas;
{
   ...
   $OPEN curTarifaSocial USING :nroCliente;
...
$long *lFilas;
{
   ...
   $OPEN curTasasVig USING :nroCliente;
